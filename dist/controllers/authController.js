...
exports.googleAuth = exports.validateResetToken = exports.resetPassword = exports.forgotPassword = exports.singleDevice = exports.logout = exports.logoutAllDevices = exports.getCurrentUser = exports.login = exports.register = void 0;
...
const singleDevice = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const deviceInfo = yield UserSession_1.default.findOne({
            userId: id,
            isActive: true,
...
const resetPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield UserSession_1.default.updateMany({ userId: user._id, isActive: true }, { isActive: false });
        res.status(200).json({
            success: true,
